        ...
        <div className="px-10 py-8 border-b border-zinc-100 flex items-center justify-between bg-[#fff5f5]">
          <div>
            <div className="flex items-center gap-2 text-red-600 mb-1">
              ...
              <h2 className="text-2xl font-bold tracking-tight">Pengaduan Kerusakan</h2>
            </div>
            <p className="text-zinc-500 text-xs font-medium">Laporkan masalah teknis atau kerusakan aset</p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-10 space-y-8">
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  placeholder="misal: Laptop Dell XPS 15"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <label className="text-[10px] font-bold uppercase tracking-[0.15em] text-zinc-400 ml-1">Lokasi Kejadian</label>
                <div className="relative">
                  ...
                  <input 
                    ...
                    placeholder="misal: Ruang Rapat"
                  />
                </div>
              </div>

              <div className="space-y-2">
                <label className="text-[10px] font-bold uppercase tracking-[0.15em] text-zinc-400 ml-1">Tanggal Temuan</label>
                <div className="relative">
