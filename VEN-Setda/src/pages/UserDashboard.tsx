        ...
        <header className="flex flex-col md:flex-row md:items-center justify-between mb-12 gap-6">
          ...
          <div className="flex items-center gap-3">
            <button 
              ...
              className="flex items-center gap-2 px-6 py-3 bg-blue-50 text-blue-600 rounded-2xl hover:bg-blue-100 transition-all font-bold text-sm border border-blue-100"
            >
              <ClipboardList size={18} />
              <span className="hidden sm:inline">Minta Barang</span>
            </button>
            <button 
              ...
              >
                ...
                <div className="p-6 flex-grow flex flex-col">
                  <div className="mb-6">
                    ...
                    <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mt-1">{item.brand_type || 'Tanpa Merek'}</p>
                  </div>
        ...
        {isRequestOpen && (
          <ItemRequestForm 
            ...
            onSuccess={() => {
              ...
              alert('Permintaan barang berhasil dikirim. Kami akan segera meninjau permintaan Anda.');
            }}
          />
        )}
      </div>
